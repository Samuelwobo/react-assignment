  ...
  return (
    <>
       <div className="hero-section ">
                <div className="hero-title bg-[url('src/assests/IMAGES/VR-Technology-VR-in-Ecommerce.jpg')] custom-bg-image w-[98%] h-[450px] flex items-center justify-between bg-center bg-cover rounded-lg">
